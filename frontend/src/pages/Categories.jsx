...
export const Categories = () => {
  ...
  const handleSaveCategory = async (data) => {
    ...
    try {
      if (editingCategory) {
        const res = await api.updateCategory(editingCategory.id, data);
        if (res.success) {
          setCategories((prev) =>
            prev.map((c) =>
              c.id === editingCategory.id ? { ...c, name: res.data.name } : c
            )
          );
    ...
    <div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Create categories like 'Engineering', 'Marketing', or 'Personal' to better organize your tasks."
